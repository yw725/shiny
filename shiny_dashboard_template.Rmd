...
# selectInput widget
selectInput(
  "boro_choice", #name the input
  label = h3("Select boro"),#labeling
  choices = boros, selected = "Manhattan")#the resources of the choices
...
```{r}
# make sure things change when people put different input
#renderPrint({ 
 # input[["boro_choice"]]
#})
